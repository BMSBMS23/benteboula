...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    $delete= mysqli_query($conn,"DELETE FROM apprenants WHERE ApprenantID = '$id'");
    if($delete){
    ...
    <section class="container" style="width: 80%;margin-left:7%;margin-top:1%;">
        <div class="row">
            <div class="col-lg-8 col-sm" style="margin-left:10%; margin-bottom:2%;">
                <h1 class="fs-2 text-center lead text-primary" style="font-family:Verdana, Geneva, Tahoma, sans-serif">Gestion des Apprenants</h1>
            </div>
        </div>
        <div class="dropdown-divider" style="margin-bottom: 15px; margin-right: 8%; border-top:1px solid #ccccd0;"></div>
        <div class="row">
            <div class="col-md-4">
                <h5 class="fw-bold mb-0"> La liste des apprenants</h5>
            </div>
            <div class="col-md-7">
            ...
            <table class="table">
                <thead class="table-light">
                  ...
                  <tr>
                    ...
                    <th scope="col"style="width: 3%;">DateNaissance</th>
                ...
                <tbody>
                    <?php
                        while ($row = mysqli_fetch_assoc($result)) {
                            ?>
                  <tr>
                        <td style=" text-align: start;"><?=$row['ApprenantID']?></td>
                        ...
                        <td style=" text-align: start;"><?=$row['Cours']?></td>
                            
                    <td>
                      
                        <a href="edit.php?edit=<?=$row['ApprenantID']?>" class="text-primary me-2 editbtn"title="Modifier"><i class="fas fa-edit"></i></a>
                     
                        <a href="apradm.php?delete=<?php echo $row['ApprenantID']?>" onclick="return confirm('Voulez-vous supprimer cette personne ?')" class="text-danger me-2 deletebtn"title="supprimer"><i class="fas fa-trash-alt"></i></a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="createModalLabel">Nouveau apprenant</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          
            <form action="" method="post" autocomplete="off" id="add" >
            <input type="hidden" id="action" value="createap" >
                <div class="mb-3">
